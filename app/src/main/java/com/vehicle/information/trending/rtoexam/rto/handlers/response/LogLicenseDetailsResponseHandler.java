...
public class LogLicenseDetailsResponseHandler implements TaskHandler.JsonResponseHandler {
    private TaskHandler.ResponseHandler<JSONObject> responseHandler;

    public LogLicenseDetailsResponseHandler(TaskHandler.ResponseHandler<JSONObject> responseHandler2) {
