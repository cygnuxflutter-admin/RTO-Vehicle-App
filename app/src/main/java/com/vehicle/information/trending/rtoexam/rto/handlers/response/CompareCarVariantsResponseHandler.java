...
public class CompareCarVariantsResponseHandler implements TaskHandler.JsonResponseHandler {
    private TaskHandler.ResponseHandler<CompareCarVariantsResponse> responseHandler;

    public CompareCarVariantsResponseHandler(TaskHandler.ResponseHandler<CompareCarVariantsResponse> responseHandler2) {
    ...
    public void onResponse(JSONObject jSONObject) {
        try {
            this.responseHandler.onResponse((CompareCarVariantsResponse) new Gson().fromJson(jSONObject.toString(), CompareCarVariantsResponse.class));
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
