...
public class CarBikeAccessoriesResponseHandler implements TaskHandler.JsonResponseHandler {
    private TaskHandler.ResponseHandler<CarBikeAccessoriesResponse> responseHandler;

    public CarBikeAccessoriesResponseHandler(TaskHandler.ResponseHandler<CarBikeAccessoriesResponse> responseHandler2) {
    ...
    public void onResponse(JSONObject jSONObject) {
        try {
            this.responseHandler.onResponse((CarBikeAccessoriesResponse) new Gson().fromJson(jSONObject.toString(), CarBikeAccessoriesResponse.class));
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
